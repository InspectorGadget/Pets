			...
			case "spawn":
				if ($sender->hasPermission('pet.command.spawn')) {
					if (isset($args[1])) {
						switch ($args[1]) {
							case "Dog":
								if ($r = /*EconomyAPI::getInstance()->reduceMoney($sender, 1500)*/true) {
								...
								break;
							case "Pig":
								if ($r = /*EconomyAPI::getInstance()->reduceMoney($sender, 750)*/true) {
									# Cool, everything is fine.
								...
								break;
							case "Rabbit":
								if ($r = /*EconomyAPI::getInstance()->reduceMoney($sender, 1000)*/true) {
									# Cool, everything is fine.
